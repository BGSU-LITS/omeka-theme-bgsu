...
$theme_query = http_build_query(
    ...
    array(
        ...
        'brand-primary' => '#8a101e',

        // Color for headings.
        'headings-color' => '#2f343b'
    ),
    '',
    '&'
);
...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'navbar' =>
            ...
            ' src="'. img('logo/vpi.png'). '"'.
            ' alt="'. __('Vintage Paperback Index'). '">',
