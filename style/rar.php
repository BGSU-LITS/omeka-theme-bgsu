...
$theme_query = http_build_query(
    ...
    array(
        ...
        'brand-primary' => '#646463',

        // Background for primary buttons.
        'btn-primary-bg' => '#000',

        // Color for headings.
        'headings-color' => '#9d0202',

	// Font stack for body text.
	'font-family-base' => '"Franklin Gothic Book", Arial, sans-serif',

        // Font stack for headings.
        'headings-font-family' => '"Calisto MT", "Bookman Old Style", Bookman, "Goudy Old Style", Garamond, "Hoefler Text", "Bitstream Charter", Georgia, serif'
    ),
    '',
    '&'
);
...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'header' =>
            '<img width="296" height="115" class="logo-header"'.
            ' src="'. img('logo/rar.png'). '"'.
            ' alt="'. __('Race and Resistance: Then and Now'). '">',
        ...
        'footer' =>
            ...
            ' src="https://lib.bgsu.edu/assets/img/ul-white.svg"'.
