...
$theme_query = http_build_query(
    ...
    array(
        ...
        'brand-primary' => '#ff5a3e',

        // Background for primary buttons.
        'btn-primary-bg' => '#4e4279',
...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'header' =>
            '<img width="92" height="128" class="logo-header"'.
            ' src="'. img('logo/nyc.png'). '"'.
            ' alt="'. __('The 1960s and Youth Culture'). '">',
