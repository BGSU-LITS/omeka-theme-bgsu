...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'navbar' =>
            '<img width="325" height="66" class="logo-navbar"'.
            ' src="'. img('logo/lrsh.svg'). '"'.
            ' alt="'. __('The Little Red School House'). '">',
