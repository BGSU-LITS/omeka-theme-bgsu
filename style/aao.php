...
$theme_query = http_build_query(
    ...
    array(
        ...
        'brand-primary' => '#86341f',

        // Background for primary buttons.
        'btn-primary-bg' => '#4d6b6d',

        // Color for headings.
        'headings-color' => '#4d6b6d'
    ),
    '',
    '&'
);
...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'navbar' =>
            '<img width="250" height="173" class="logo-navbar"'.
            ' src="'. img('logo/aao.svg'). '"'.
            ' alt="'. __('Atomic Age Opens Postcard Project'). '">',
