...
$theme_query = http_build_query(
    ...
    array(
        ...
        'brand-primary' => '#F9A31A',

        // Background for primary buttons.
        'btn-primary-bg' => '#32698A',

        // Color for headings.
        'headings-color' => '#981B1E',

        // Color of body text.
        'text-color' => '#231F20',

        // Font stack for headings.
        'font-family-base' => "'Bookman Old Style', Georgia, serif;"
    ),
    '',
    '&'
);
...
$theme_style = array(
    ...
    'logo' => array(
        ...
        'navbar' =>
            '<img width="332" height="112" class="logo-navbar"'.
            ' src="'. img('logo/sdg.svg'). '"'.
            ' alt="'. __('Student Digital Gallery'). '">',
